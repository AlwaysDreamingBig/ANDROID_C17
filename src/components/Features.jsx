    ...
    <Section id={'features'} crosses>
      <div className='container relative z-2'>
        ...
        <div className='wrap flex-1 gap-10 mb-10 grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1'>
          {benefits.map((item) => (
            <div
              className={`class="h-36 w-full bg-gradient-to-b ${gradientColors[item.id]}  p-1" block relative bg-no-repeat bg-[length:100%_100%] md:max-w-[24rem] transform hover:scale-105 transition-transform duration-300 rounded-[12%] overflow-hidden p-0.5`}
              key={item.id}
            >
              <div className='relative z-2 flex flex-col min-h-[22rem] p-[2.4rem] rounded-[12%] bg-gray-800 border-red-500 border'>
